...
implicit none
  ...
  interface initialise_field
    ...
    module procedure initialise_scalar_field, initialise_vector_field, initialise_tensor_field, initialise_scalar_field_ATHAM, initialise_vector_field_ATHAM, initialise_tensor_field_ATHAM
...
contains
  ...
  recursive subroutine initialise_scalar_field_ATHAM(state, field, path, position, time, phase_path, field_name, surface_element_list)
  ...
  end subroutine initialise_scalar_field_ATHAM

  subroutine initialise_vector_field_ATHAM(state, field, path, position, time, phase_path, field_name, surface_element_list)
    !!< Initialises field with values prescribed in option_path
    !!< This is used for initial conditions, prescribed fields and
    !!< setting a boundary condition surface_field, a.o.
    type(state_type), intent(in) :: state
  ...
  end subroutine initialise_vector_field_ATHAM

  subroutine initialise_tensor_field_ATHAM(state, field, path, position, time, phase_path, field_name)
    !!< Initialises field with values prescribed in option_path
    !!< This is used for initial conditions, prescribed fields and
    !!< setting a boundary condition surface_field, a.o.
    type(state_type), intent(in) :: state
  ...
  end subroutine initialise_tensor_field_ATHAM
